...
4. Async XCM status clarified: assembler, SetTopic validation, and wrapper precompile `send` dispatch are shipped, while native observer proof remains a production gate.
