/* Averray Policies — seed data.
   22 policies modelled after the agent repo vocabulary: claim / settle / xcm /
   badge / co-sign / worker / treasury. Every address and hash is synthetic but
   shaped like real Substrate/EVM output. */
...
const S = (...keys) => keys.map(k => ({ key: k, ...SIGNERS[k] }));

// Approval state helpers
const approved = (signer, at, sig) => ({ ...signer, state: "signed", at, sig });
const pending  = (signer)          => ({ ...signer, state: "pending" });
const declined = (signer, at)      => ({ ...signer, state: "declined", at });
...
const policies = [
  // ---------- CLAIM ----------
  {
    ...
    lastChange: { text: "Raised max-cvss from 6.0 to 7.5 for auto-pass",
                  author: "fd2e", at: "2026-04-19 11:04 UTC" },
    state: "Active",
    revision: 4,
  ...
  "require": { "advisory_type": "security" }
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-04-19 11:04 UTC", "0x7a0c…b11e"),
      approved(SIGNERS["9a13"], "2026-04-19 11:09 UTC", "0x84df…2241"),
      approved(SIGNERS["3e42"], "2026-04-19 11:12 UTC", "0x9e11…6ab0"),
    ],
    history: [
  ...
  },
  {
    ...
    lastChange: { text: "Require ≥2 internal citations per 300 words",
                  author: "9a13", at: "2026-04-15 09:20 UTC" },
    state: "Active",
    revision: 3,
  ...
  "require": { "citations.external.allowed": false }
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-04-15 09:20 UTC", "0x1b77…04e2"),
      approved(SIGNERS["9a13"], "2026-04-15 09:24 UTC", "0xaa3c…91d0"),
      approved(SIGNERS.c8f1, "2026-04-15 09:40 UTC", "0x5e02…7712"),
    ],
    history: [
  ...
  },
  {
    ...
    lastChange: { text: "ed25519 required on every handoff payload",
                  author: "3e42", at: "2026-03-01 08:12 UTC" },
    state: "Active",
    revision: 2,
    ...
    attachedJobs: [
      { id: "run-2739", title: "sig-mismatch on handoff — disputed", at: "14:02 UTC" },
    ],
    rule: {
      v2: `{
  "kind": "claim.gate",
  ...
  "on_fail": "dispute"
    ...
    approvals: [
      approved(SIGNERS.fd2e,     "2026-03-01 08:12 UTC", "0x0c44…a1fe"),
      approved(SIGNERS["9a13"], "2026-03-01 08:14 UTC", "0xe1b8…5d02"),
      approved(SIGNERS["3e42"], "2026-03-01 08:19 UTC", "0x7715…9a14"),
    ],
    history: [
  ...
  // ---------- SETTLE ----------
  {
    ...
    lastChange: { text: "Floor raised: co-sign required over 50 DOT (was 100)",
                  author: "b70c", at: "2026-04-08 16:44 UTC" },
    state: "Active",
    revision: 5,
  ...
  "require": { "co_sign.min": 2 }
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-04-08 16:44 UTC", "0x2a8d…f401"),
      approved(SIGNERS["9a13"], "2026-04-08 16:47 UTC", "0xbe70…10ac"),
      approved(SIGNERS.b70c, "2026-04-08 16:52 UTC", "0x4410…29bf"),
    ],
    history: [
  ...
  },
  {
    ...
    lastChange: { text: "Verifier now checks receipt hash across last 3 blocks",
                  author: "3e42", at: "2026-02-28 13:05 UTC" },
    state: "Active",
    revision: 2,
    rooms: ["runs/*/settle"],
  ...
  "require": { "receipt.hash.matches_attestation": true }
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-02-28 13:05 UTC", "0x91a0…5501"),
      approved(SIGNERS["3e42"], "2026-02-28 13:11 UTC", "0x5f24…c8b2"),
      approved(SIGNERS["9a13"], "2026-02-28 13:14 UTC", "0x1d4e…9a8e"),
    ],
    history: [
  ...
  // ---------- XCM ----------
  {
    ...
    lastChange: { text: "Added AssetHub (1000) and Bridge Hub (1002); removed deprecated parachain 2034",
                  author: "c8f1", at: "2026-04-11 07:58 UTC" },
    state: "Active",
    revision: 6,
    rooms: ["xcm/outbound/*"],
    ...
    attachedJobs: [
      { id: "run-2726", title: "xcm → AssetHub (1000) · 48 DOT", at: "11:15 UTC" },
    ],
    rule: {
      v6: `{
  "kind": "xcm.gate",
  ...
  "require": { "dest.paraId.in": [1000, 2034] }
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-04-11 07:58 UTC", "0xfe19…0a2b"),
      approved(SIGNERS["9a13"], "2026-04-11 08:01 UTC", "0xac87…d0f4"),
      approved(SIGNERS.c8f1, "2026-04-11 08:14 UTC", "0x2240…9e16"),
    ],
    history: [
  ...
  },
  {
    ...
    lastChange: { text: "Cap lowered from 5 → 2 DOT per message",
                  author: "b70c", at: "2026-01-28 10:30 UTC" },
    state: "Active",
    revision: 3,
    rooms: ["xcm/outbound/*"],
  ...
  "on_fail": "gate"
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-01-28 10:30 UTC", "0x6622…118e"),
      approved(SIGNERS.b70c, "2026-01-28 10:33 UTC", "0xdd21…9073"),
      approved(SIGNERS["9a13"], "2026-01-28 10:40 UTC", "0x8a18…e502"),
    ],
    history: [
  ...
  // ---------- BADGE ----------
  {
    ...
    lastChange: { text: "Pass count raised from 3 → 5 for coding-1",
                  author: "c8f1", at: "2026-04-17 14:20 UTC" },
    state: "Active",
    revision: 2,
    ...
    attachedJobs: [
      { id: "run-2737", title: "mint coding-1 → writer-gov-1", at: "13:40 UTC" },
    ],
    rule: {
      v2: `{
  ...
  "require": { "consecutive_passes.min": 3 }
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-04-17 14:20 UTC", "0x3c90…aa11"),
      approved(SIGNERS.c8f1, "2026-04-17 14:25 UTC", "0x78e2…0c4b"),
      pending(SIGNERS["5d09"]),
    ],
    history: [
  ...
  },
  {
    ...
    attachedJobs: [
      { id: "run-2739", title: "sig-mismatch on handoff — badge suspended", at: "14:02 UTC" },
    ],
    rule: {
      v1: `{
  ...
  "reinstate_on": "dispute.resolved.ok"
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2025-09-20 08:00 UTC", "0xf1b0…4498"),
      approved(SIGNERS["9a13"], "2025-09-20 08:02 UTC", "0x2205…13e0"),
      approved(SIGNERS.c8f1, "2025-09-20 08:11 UTC", "0xa77b…55f1"),
    ],
    history: [
  ...
  // ---------- CO-SIGN ----------
  {
    ...
    lastChange: { text: "Default quorum from 1-of-2 to 2-of-3",
                  author: "fd2e", at: "2026-02-14 11:00 UTC" },
    state: "Active",
    revision: 2,
    rooms: ["*"],
  ...
  "applies_to": ["settle"]
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-02-14 11:00 UTC", "0x0044…887a"),
      approved(SIGNERS["9a13"], "2026-02-14 11:02 UTC", "0xa1cc…2920"),
      approved(SIGNERS.b70c, "2026-02-14 11:05 UTC", "0x5dd3…0101"),
    ],
    history: [
  ...
  "on_fail": "hard_stop"
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2025-10-02 09:14 UTC", "0x4a22…bb01"),
      approved(SIGNERS.b70c, "2025-10-02 09:16 UTC", "0x99fe…12d4"),
      approved(SIGNERS["9a13"], "2025-10-02 09:22 UTC", "0x3300…5e7a"),
    ],
    history: [
  ...
  },
  {
    ...
    lastChange: { text: "Minimum raised from 5 → 10 DOT",
                  author: "b70c", at: "2026-03-22 15:30 UTC" },
    state: "Active",
    revision: 3,
    rooms: ["workers/*/claim"],
    ...
    attachedJobs: [
      { id: "run-2732", title: "stake top-up · coding-hand-1", at: "12:02 UTC" },
    ],
    rule: {
      v3: `{
  "kind": "worker.gate",
  ...
  "source": "AgentAccountCore"
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-03-22 15:30 UTC", "0x7711…aa09"),
      approved(SIGNERS.b70c, "2026-03-22 15:33 UTC", "0xba45…0c0c"),
      pending(SIGNERS.c8f1),
    ],
    history: [
  ...
  // ---------- TREASURY ----------
  {
    ...
    lastChange: { text: "Daily cap 1,000 → 750 DOT after Q1 review",
                  author: "b70c", at: "2026-04-02 09:00 UTC" },
    state: "Active",
    revision: 4,
  ...
  "require": {
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-04-02 09:00 UTC", "0x2a11…f8b0"),
      approved(SIGNERS.b70c, "2026-04-02 09:04 UTC", "0x0e55…aa21"),
      approved(SIGNERS.c8f1, "2026-04-02 09:22 UTC", "0xffee…1010"),
    ],
    history: [
  ...
  },
  {
    ...
    lastChange: { text: "Floor raised to 8% of rolling 30d payouts",
                  author: "b70c", at: "2026-03-30 10:12 UTC" },
    state: "Active",
    revision: 2,
    rooms: ["treasury/*"],
  ...
  "on_fail": "hard_stop"
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-03-30 10:12 UTC", "0x8800…4411"),
      approved(SIGNERS.b70c, "2026-03-30 10:14 UTC", "0xbbcc…aa22"),
      approved(SIGNERS.c8f1, "2026-03-30 10:30 UTC", "0xd1d0…e5ee"),
    ],
    history: [
  ...
  // ---------- Pending ----------
  {
    ...
    signerKeys: ["fd2e", "9a13", "c8f1"],
    activeSince: null,
    lastChange: { text: "Proposed — awaiting 2 more signers",
                  author: "c8f1", at: "2026-04-23 18:20 UTC" },
    state: "Pending",
    revision: 1,
  ...
  "require": {
    ...
    approvals: [
      approved(SIGNERS.c8f1, "2026-04-23 18:20 UTC", "0xaaa0…1177"),
      pending(SIGNERS.fd2e),
      pending(SIGNERS["9a13"]),
    ],
    history: [
  ...
  },
  {
    ...
    signerKeys: ["fd2e", "9a13", "b70c"],
    activeSince: null,
    lastChange: { text: "Proposed — awaiting 1 more signer",
                  author: "b70c", at: "2026-04-24 06:44 UTC" },
    state: "Pending",
    revision: 1,
    rooms: ["runs/*/settle"],
  ...
  "on_fail": "gate"
    ...
    approvals: [
      approved(SIGNERS.b70c, "2026-04-24 06:44 UTC", "0x1234…5678"),
      approved(SIGNERS.fd2e, "2026-04-24 06:49 UTC", "0x7e11…90cc"),
      pending(SIGNERS["9a13"]),
    ],
    history: [
  ...
  },
  {
    ...
    activeSince: null,
    lastChange: { text: "Proposed — awaiting 2 more signers",
                  author: "c8f1", at: "2026-04-22 14:50 UTC" },
    state: "Pending",
    revision: 1,
  ...
  "require": {
    ...
    approvals: [
      approved(SIGNERS.c8f1, "2026-04-22 14:50 UTC", "0xccee…2299"),
      pending(SIGNERS.fd2e),
      pending(SIGNERS["5d09"]),
    ],
    history: [
  ...
  // ---------- Drafts ----------
  {
    ...
    signerKeys: ["fd2e", "9a13", "c8f1"],
    activeSince: null,
    lastChange: { text: "Draft — never proposed",
                  author: "fd2e", at: "2026-04-10 16:12 UTC" },
    state: "Draft",
    revision: 1,
    rooms: ["runs/*/review"],
  ...
  "require": { "reviewer.badge.coding-1.age_days": 30 }
    ...
    history: [
      { rev: 1, author: "fd2e", at: "2026-04-10", summary: "Draft — reviewer tenure requirement.", active: true },
    ],
  },
  {
    id: "p-19",
    ...
    activeSince: null,
    lastChange: { text: "Draft — data source wiring pending",
                  author: "b70c", at: "2026-04-20 11:33 UTC" },
    state: "Draft",
    revision: 1,
    rooms: ["treasury/*"],
  ...
  "publish": {
    ...
    approvals: [
      pending(SIGNERS.fd2e),
      pending(SIGNERS.b70c),
      pending(SIGNERS["5d09"]),
    ],
    history: [
      { rev: 1, author: "b70c", at: "2026-04-20", summary: "Draft — monthly report cadence.", active: true },
    ],
  },
  ...
  // ---------- Retired ----------
  {
    ...
    signerKeys: ["fd2e", "9a13", "c8f1"],
    activeSince: "2025-07-04",
    lastChange: { text: "Retired — superseded by xcm/relay-allowlist@v4+",
                  author: "fd2e", at: "2025-11-30 17:00 UTC" },
    state: "Retired",
    revision: 1,
    rooms: ["xcm/outbound/*"],
  ...
  "require": { "instruction.type": "TeleportAsset" }
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2025-11-30 17:00 UTC", "0xffff…eeee"),
      approved(SIGNERS["9a13"], "2025-11-30 17:02 UTC", "0xdddd…cccc"),
      approved(SIGNERS.c8f1, "2025-11-30 17:08 UTC", "0xbbbb…aaaa"),
    ],
    history: [
      { rev: 1, author: "fd2e", at: "2025-07-04", summary: "Initial — teleport-only gate. Retired 2025-11-30.", active: true },
    ],
  },
  {
    id: "p-21",
    ...
    lastChange: { text: "Retired — replaced by scoped auto-claim policies",
                  author: "fd2e", at: "2025-10-01 09:00 UTC" },
    state: "Retired",
    revision: 1,
    rooms: ["runs/*"],
  ...
  "require": { "manual_review": true }
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2025-10-01 09:00 UTC", "0xa1a1…b2b2"),
      approved(SIGNERS["9a13"], "2025-10-01 09:01 UTC", "0xc3c3…d4d4"),
      approved(SIGNERS["3e42"], "2025-10-01 09:05 UTC", "0xe5e5…f6f6"),
    ],
    history: [
      { rev: 1, author: "fd2e", at: "2025-06-10", summary: "Initial — manual review all. Retired 2025-10-01.", active: true },
    ],
  },
  ...
  // ---------- One more co-sign ----------
  {
    ...
    lastChange: { text: "All hard-stop policy changes now require unanimous co-sign",
                  author: "c8f1", at: "2026-03-05 12:40 UTC" },
    state: "Active",
    revision: 2,
  ...
  "threshold": "2_of_3"
    ...
    approvals: [
      approved(SIGNERS.fd2e, "2026-03-05 12:40 UTC", "0x1919…aaff"),
      approved(SIGNERS["9a13"], "2026-03-05 12:44 UTC", "0x2828…bbee"),
      approved(SIGNERS.c8f1, "2026-03-05 13:02 UTC", "0x3737…ccdd"),
    ],
    history: [
...
// Aggregates
const AGG_ACTIVE  = policies.filter(p => p.state === "Active").length;
const AGG_PENDING = policies.filter(p => p.state === "Pending").length;
const AGG_DRAFT   = policies.filter(p => p.state === "Draft").length;
const AGG_RETIRED = policies.filter(p => p.state === "Retired").length;
const AGG_REVISIONS_30D = 9; // hard-coded sparkline target

// 30-day revision sparkline (daily churn) — 30 points, 0..5 range
const SPARK_30D = [0,0,1,0,2,0,1,0,0,3,1,0,0,1,0,2,0,0,1,0,0,4,1,0,0,2,0,1,0,1];

Object.assign(window, {
  SIGNERS, policies,
  AGG_ACTIVE, AGG_PENDING, AGG_DRAFT, AGG_RETIRED, AGG_REVISIONS_30D,
  SPARK_30D,
});
