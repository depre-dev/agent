...
import { SPARK_30D } from "./policies-data";
  ...
  return (
    <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
      ...
      <Card
        label="Revisions · 30d"
        value={revisions30d}
        meta="policy churn · last 30 days"
        right={<Sparkline points={SPARK_30D} width={120} height={32} />}
      />
      <Card
        label="Signer quorum"
        value="2 of 3"
